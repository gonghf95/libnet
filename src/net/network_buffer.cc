...
NetworkBuffer::NetworkBuffer(const unsigned size, ConnectObj *obj)
	: obj_(obj)
{
	_bufferSize = size;
	_beginIndex = 0;
...
RecvNetworkBuffer::RecvNetworkBuffer(const unsigned int _size, ConnectObj *obj)
	: NetworkBuffer(_size, obj)
{
}
...
SendNetworkBuffer::SendNetworkBuffer(const unsigned int _size, ConnectObj *obj)
	: NetworkBuffer(_size, obj)
{
}
